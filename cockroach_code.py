...
link = 'postgresql://ofir:zPfIA64Mol4tYZCf@free-tier.gcp-us-central1.cockroachlabs.cloud:26257/wifi_data?sslmode=verify-full&sslrootcert=/Users/ofirdvir/.postgresql/root.crt&options=--cluster%3Dwifi-crowdsourcing-4313'
...
def write_into_db(filename):
    ...
    with conn.cursor() as cur:
        cur.execute("INSERT INTO wifi_data (latitude, longitude, floor_id, building_id, date_time, "
                    ...
                    payload["lat"], payload["long"], payload['flrID'], payload['bldID'], payload["dateTime"], payload["wifiName"],
